...
A fully functional **DEPENDENCY-FREE** Rich Text Editor for both Android and iOS, based off the project by Wix, based off [ZSSRichTextEditor](https://github.com/nnhubbard/ZSSRichTextEditor/tree/master/ZSSRichTextEditor) project. 
